    ...
    <div>
      ...
      <Container>
        ...
        <Paragraph>
          ...
          Wateke usa y protege la información que es proporcionada por sus
        ...
        <Paragraph>
          ...
          <br /> <br />
          Wateke está altamente comprometido para cumplir con el compromiso de
        ...
        <Paragraph>
          ...
          <br />
          <br />
          Wateke Se reserva el derecho de cambiar los términos de la presente
