...
import {SpotUserVM, User} from '../../../web/src/core/domain/auth/User';
import UserRepository from '../../../web/src/core/domain/auth/UserRepository';
import {ReplyPayload} from '../../../web/src/core/domain/chat/Chat';
...
import {
  ...
  Song,
  SongVM,
} from '../../../web/src/core/domain/music/Music';
import MusicDurationFormatter from '../../../web/src/core/domain/music/MusicDurationParser';
...
export default class DashboardBloc extends Cubit<DashboardState> {
  ...
  private onCurrentSongChanged = (currentSong: PublishedSong) => {
    ...
    const suggestions = this.updateSuggestionsStatus();
    this.emit({...this.state, foundSongs, suggestions});
    if (this.isPlayerReady) this.loadSuggestions();
  };
